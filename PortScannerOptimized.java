...
public class PortScannerOptimized {
   ...
   private static final String PP_SHELL_CMD_FORMAT = "D:\\a\\java\\java\\ForceP2PMediaPlayer\\ppshell.exe -o %d"; // 假设ppshell.exe在PATH环境变量中可找到
    private static final ExecutorService executor = Executors.newFixedThreadPool(80); // 创建线程池
    ...
    public static void main(String[] args) throws InterruptedException {
        //while (true) {
            int startPort = 10006;
            int endPort = 60000;
            CountDownLatch latch = new CountDownLatch(80); // 线程池大小
            doThread(startPort, endPort, 1, latch);
            latch.await(); // 等待cmdType为2的任务完成
            CountDownLatch latch1 = new CountDownLatch(80); // 线程池大小
