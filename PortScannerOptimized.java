...
public class PortScannerOptimized {
    ...
    private static final ExecutorService executor = Executors.newFixedThreadPool(45); // 创建线程池
    ...
    public static void main(String[] args) throws InterruptedException {
        //while (true) {
            int startPort = 10006;
            int endPort = 60000;
            CountDownLatch latch = new CountDownLatch(45); // 线程池大小
            doThread(startPort, endPort, 1, latch);
            latch.await(); // 等待cmdType为2的任务完成
            CountDownLatch latch1 = new CountDownLatch(45); // 线程池大小
